...
/**
 * Service class for handling agent-related operations within the admin panel.
 *
 * This service is responsible for fetching and preparing agent data
...
class AgentService
{
    ...
    /**
     * Retrieves a paginated list of all users with the 'Agent' role.
     *
     ...
     */
    public function getPaginatedAgents(int $page, int $limit): array
    {
        $paginator = $this->userRepository->findPaginatedAgents($page, $limit);
